...
#[doc = "  @brief node1为一个空结构体\n 在 C 中空结构体的大小为 0 字节\n 在 C++ 中空结构体的大小为 1 字节"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct node1 {}
#[doc = "  @brief node1为一个空结构体\n 在 C 中空结构体的大小为 0 字节\n 在 C++ 中空结构体的大小为 1 字节"]
pub type S1 = node1;
#[doc = " @brief node2的内存结构\n (4 — 1 — 1 (补) — 2), 总大小为 8 字节\n\n (结构体的每一个成员相对结构体首地址的偏移量应该是对其参数的整数倍)"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct node2 {
